...
import edu.pnu.service.dashboard.DashbordeService;
...
public class DashboardController {
    private final DashbordeService dashbordeService;

    @GetMapping("/kpi")
    public DashboardDTO.KpiResponse getKPIAnlaysis(@RequestParam Long fileId) {
        log.info("[진입] : [DashboardController] Kpi 정보 load 진입");
        DashboardDTO.KpiResponse dto = dashbordeService.getKPIAnlaysis(fileId);
        if(dto == null) {
